...
const AddNewMemberContent = () => {
    ...
    const { closeDialog } = useScrumBoardStore()
    ...
    const onAddMember = async (member) => {
        ...
        console.log('Adding member to scrum board:', member)
    ...
    return (
        <div>
            ...
            >
                <p>
                    Tem certeza que deseja remover o acesso de <strong>{confirmDialog.member?.name}</strong> ao quadro Scrum?
                </p>
                <p className="text-sm text-gray-600 mt-2">
                    Este usuário perderá acesso à página do quadro Scrum e não poderá mais ser adicionado a novos projetos, mas permanecerá nos projetos existentes.
                </p>
            </ConfirmDialog>
        </div>
    )
