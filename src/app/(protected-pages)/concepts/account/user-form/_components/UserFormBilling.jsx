...
import BillingHistory from '@/app/(protected-pages)/concepts/account/settings/_components/BillingHistory'
...
const UserFormBilling = () => {
    ...
    const [data] = useState({
        currentPlan: {
            ...
            nextPaymentDate: 1640995200 + 30 * 24 * 60 * 60, // Fixed timestamp: 30 days from 2022-01-01
            amount: 29.99,
        },
        paymentMethods: [
            {
        ...
        transactionHistory: [
            {
                ...
                type: 'payment',
                amount: 29.99,
                date: 1640995200 - 7 * 24 * 60 * 60, // Fixed timestamp: 7 days before 2022-01-01
                status: 'completed',
...
export default UserFormBilling
